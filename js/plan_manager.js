...
class PlanManager {
    ...
    async loadIfcBimModel(arrayBuffer, fileName, dropzoneTitle) {
        ...
        alert(`✓ تم استيراد ونمذجة مشروع الـ IFC المعماري بالكامل بنجاح!\n` +
              ...
              `✨ تم ضبط الاستقامة وتوسيط المبنى تلقائياً على شبكة الأرضية (بدون بطئ أو Lagging).\n` +
              `يمكنك تدوير النموذج بحرية عبر أزرار ⤴️ X / ⤵️ Y / 🔄 Z في لوحة التحكم، وعزل الطوابق وفحص خصائص أي عنصر عبر النقر المباشر أو نافذة "🏢 عارض عناصر IFC".`);
    }
